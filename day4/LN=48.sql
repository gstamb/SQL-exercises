...
-- link https://www.sql-ex.ru/learn_exercises.php?LN=48
-- Solution
SELECT class
FROM   ships
WHERE  NAME IN (SELECT o.ship FROM   outcomes o WHERE  o.result = 'sunk')
UNION
SELECT class
FROM   classes
WHERE  class IN (SELECT o.ship FROM   outcomes o WHERE  o.result = 'sunk')
