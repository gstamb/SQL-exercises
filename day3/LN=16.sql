...
-- link https://www.sql-ex.ru/learn_exercises.php?LN=16

-- Solution
SELECT DISTINCT v1.model AS first_run, v2.model AS second_run, v1.speed, v1.ram
FROM PC v1, PC v2
WHERE v1.speed = v2.speed AND v1.ram = v2.ram and v1.model > v2.model;
